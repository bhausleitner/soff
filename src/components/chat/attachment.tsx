...
export function Attachment({ fileName, fileKey }: AttachmentProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogTrigger asChild className="mt-2">
        <Badge
          onClick={handleOpen}
          className="flex max-w-[150px] cursor-pointer items-center space-x-2 border border-gray-300 bg-white px-2 py-2 text-gray-700 shadow-sm transition-all duration-200 ease-in-out hover:bg-gray-100"
        >
